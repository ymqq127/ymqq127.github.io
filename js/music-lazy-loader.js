...
(function () {
  ...
  style.textContent = '#pink-music-btn{position:fixed;right:20px;bottom:80px;width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,#FF85A2,#FFB6C1);color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:999;box-shadow:0 2px 12px rgba(255,133,162,.4);transition:transform .2s,box-shadow .2s;animation:pink-pulse 2s infinite}#pink-music-btn:hover{transform:scale(1.1);box-shadow:0 4px 20px rgba(255,133,162,.6)}@keyframes pink-pulse{0%,100%{box-shadow:0 2px 12px rgba(255,133,162,.4)}50%{box-shadow:0 2px 20px rgba(255,133,162,.7)}}#pink-music-btn.loading{opacity:.6;pointer-events:none;animation:none}';
